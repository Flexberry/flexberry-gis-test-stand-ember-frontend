...
moduleForModel('i-i-s-flexberry-gis-test-stand-request', 'Unit | Serializer | i-i-s-flexberry-gis-test-stand-request', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-flexberry-gis-test-stand-request',
    'transform:file',
    'transform:decimal',
