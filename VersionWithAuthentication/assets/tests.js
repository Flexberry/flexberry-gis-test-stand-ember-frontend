...
define('ember-app/tests/services/session.jscs-test', ['exports'], function (exports) {
  'use strict';

  module('JSCS - services');
  test('services/session.js should pass jscs', function () {
    ok(true, 'services/session.js should pass jscs.');
  });
});
define('ember-app/tests/services/session.jshint', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/tests/services/user-settings.jscs-test', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/tests/services/user-settings.jshint', ['exports'], function (exports) {
  'use strict';
