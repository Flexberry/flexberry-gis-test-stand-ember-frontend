...
moduleForModel('i-i-s-flexberry-gis-test-stand-comment', 'Unit | Serializer | i-i-s-flexberry-gis-test-stand-comment', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-flexberry-gis-test-stand-comment',
    'transform:file',
    'transform:decimal',
