...
moduleForModel('i-i-s-flexberry-gis-test-stand-address', 'Unit | Serializer | i-i-s-flexberry-gis-test-stand-address', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-flexberry-gis-test-stand-address',
    'transform:file',
    'transform:decimal',
